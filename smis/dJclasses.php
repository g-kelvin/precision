      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <a href="dJclasses.php" type="button" class="btn btn-warning" style="text-transform: capitalize;" >DJ Classes </a>
            <a href="driving.php" type="button" class="btn btn-primary" style="text-transform: capitalize;" > Driving Academy</a>
            <br><br>

            <?php 
                          
                            $feedback="SELECT * from students WHERE status = 'Active' AND Course = 'DJ Classes' ORDER BY studentid DESC  LIMIT 10 ";
                            if ($result=mysqli_query($con,$feedback))
                            {
                            // Return the number of rows in result set
                            $rows=mysqli_num_rows($result);
                            echo "<b style = 'color: green'> Active DJ Classes Students = ". $rows. " ". "</b>";
                            // Free result set
                            mysqli_free_result($result);
                            } ?>
