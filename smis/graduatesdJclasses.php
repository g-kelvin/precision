    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          ...
          <a href="graduatesdJclasses.php" type="button" class="btn btn-warning" style="text-transform: capitalize;" >DJ Classes </a>
          <a href="graduatesdriving.php" type="button" class="btn btn-primary" style="text-transform: capitalize;" > Driving Academy</a>
            <br><br>

            <?php 
                          
                            $feedback="SELECT * from students WHERE status = 'Graduated' AND Course = 'DJ Classes' ORDER BY studentid DESC  LIMIT 10 ";
                            if ($result=mysqli_query($con,$feedback))
                            {
                            // Return the number of rows in result set
                            $rows=mysqli_num_rows($result);
                            echo "<b style = 'color: green'> Graduates DJ Classes Students = ". $rows. " ". "</b>";
                            // Free result set
                            mysqli_free_result($result);
                            } ?>
